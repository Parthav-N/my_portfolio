...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 260.0, vertical: 260.0),
        child: Column(
          ...
          children: [
            ...
            RichText(
              text: TextSpan(
                children: [
                  ...
                  TextSpan(
                    text: currentProfession, // Update with currentProfession
            ...
            Row(
              ...
              children: [
                ...
                // MyNavbar(title: 'Resume', isActive: activeRoute == Home.routeName, routeName: Home.routeName, onTap: _handleNavTap,),
                TextButton(
                  onPressed: () async {
                    // Your code to handle the button press, e.g.,
